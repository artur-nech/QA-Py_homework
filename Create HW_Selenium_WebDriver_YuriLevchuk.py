...
print(driver.find_element
      (By.LINK_TEXT, "California Real Estate").get_attribute("href"))   # print link(href) for header "California Real Estate"
time.sleep(1.5)                                                         # wait 1.5 seconds

print('Printing \'link(src)\' for first home image under  "About us":')
print(driver.find_element
      (By.XPATH, "//img[@class='wp-image-55']").get_attribute("src"))   # print link(src) for first home image under "About us"
time.sleep(1.5)                                                         # wait 1.5 seconds
